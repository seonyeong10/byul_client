...
import { AuthForm } from "@components/section";
...
function AuthContainer() {
    ...
    return (
        <AuthForm name="auth-form">
            <div>
                <AuthBtn type='button' onClick={() => socialLogin('google')}><img src={Google}/>구글로 시작하기</AuthBtn>
                <AuthBtn type='button' onClick={() => socialLogin('naver')}><img src={Naver}/>네이버로 시작하기</AuthBtn>
            </div>
        </AuthForm>
    );
}
