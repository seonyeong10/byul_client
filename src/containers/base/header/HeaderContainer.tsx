...
import { Flex } from '@components/section';
import { HeadLine } from '@components/text';
import { CurrentSubject, HeaderTop, HeaderWrapper, Subject } from '@components/base';
import { CategoryType } from '@config/types/ItemType';

import ProfileContainer from './my/ProfileContainer';
